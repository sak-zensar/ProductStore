            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Unit" ItemStyle-Width="20%" HeaderStyle-CssClass="HeaderClass">
                    ...
                    <EditItemTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="rfvUnit" runat="server" ControlToValidate="ddlUnit" InitialValue="0" ValidationGroup="vgAddProduct"
                ...
                <asp:TemplateField HeaderText="Edit" ItemStyle-Width="10%" HeaderStyle-Width="10%" HeaderStyle-CssClass="HeaderClass">
                    ...
                    <EditItemTemplate>
                        <asp:Button ID="btn_Update" runat="server" Text="Update" CommandName="Update" ValidationGroup="vgAddProduct" />
